// Shared by the profile form's State dropdown (frontend) and its server-side
// validation (backend) — one list, so the two can't drift out of sync.
...
export const COUNTRIES = [["US", "United States"]];
